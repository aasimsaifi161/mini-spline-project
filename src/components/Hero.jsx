...
const Hero = () => {
  return (
    <main className="flex lg:mt-20 flex-col lg:flex-row items-center justify-between min-h-[calc(90vh-6rem)]">
      ...
      >
        <div className="relative w-[95%] sm:w-48 h-10 bg-gradient-to-r from-[#656565] to-[#e99b63] shadow-[0_0_15px_rgba(255,255,255,0.14)] rounded-full">
        ...
        <p className="text-base sm:text-lg tracking-wider text-gray-400 max-w-[25rem] lg:max-w-[32rem]">
      ...
      <Spline
        ...
        scene="https://prod.spline.design/XPhJyM0lk-z8eHsF/scene.splinecode"
      />
    </main>
  );
};
